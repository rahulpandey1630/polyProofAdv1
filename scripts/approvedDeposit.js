...
const ABI = require("../artifacts/contracts/jet.sol/jet.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("jet");
  const nft = await NFT.attach("0x25A61BE91c708fe8960a21630C2ab6E0049CB1Bd");
